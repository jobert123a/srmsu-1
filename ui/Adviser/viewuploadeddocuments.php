    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="input-group mb-3">
            <div class="input-group-prepend">
              <span class="input-group-text" id="inputGroup-sizing-default"> Group Code</span>
            </div>
            <input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
          </div>
          <div class="input-group mb-3">
      ...
      <div class="col-md-10 offset-1 " style="background-color: white; border-radius:20px; padding:30px;">
        <table id="example" class="table table-striped table-bordered" style="background-color: white; width:100%;">
          <div class="d-flex justify-content-center">
            <h4 align="center">Group Documents </h4>
            </h4>
          ...
          <thead>
            <tr>
              ...
              <th scope="col" class="text-center">S.R.S</th>
              <th scope="col" class="text-center">Chapter 1 to 3</th>
              <th scope="col" class="text-center">Chapter 1 to 3</th>
              <th scope="col" class="text-center">Chapter 1 to 3</th>
            </tr>
          </thead>
