        ...
        <table id="example" class="table table-striped table-bordered" style="background-color: white; width:100%;">
          ...
          <thead>
            <tr>
              ...
              <th scope="col" class="text-center">Group Members </th>
              <th scope="col" class="text-center">Group Titles</th>
          ...
          <tbody>
            <tr>
              ...
              <td> <button class="button btn-info" button style="padding:5px" type="button"> Approved </i> </button>
              </td>  
